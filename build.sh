...
variables() {
    KL_DIR="drona/kernel"
    KL_DCONF=drona-phoenix_defconfig
    KL_ARCH=ARM64

    TC_DIR="drona/tc"
    ZP_DIR="drona/ak"
    ZP_KL_NAME=DronaKernel
    ZP_KL_VERSION=1.0
    ZP_KL_DEVICE=Phoenix
    ZP_APPEND_DATE=1
    ZP_COPY_DTB_IMG=0
    BUILD_OUTPUT_DIR="drona/output"

    BUILD_USER=Dronacharya
    BUILD_HOST=Jarvis
    LOCALVERSION=
    ...
    KL_REPO=https://github.com/shivamjadon/kernel
    KL_BRANCH=eleven
    TC_REPO=https://github.com/kdrag0n/proton-clang
    TC_BRANCH=master
    ZP_REPO=https://github.com/shivamjadon/anykernel
    ZP_BRANCH=main
}
